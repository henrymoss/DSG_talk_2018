...
\newenvironment{example}{\begin{list}{}%
%{\addtocounter{subsection}{1} \item[] {\bf Example \thesubsection}%book
%{\addtocounter{subsubsection}{1} \item[] {\bf Example \thesubsubsection}%art
{\addtocounter{definition}{1} \item[] {\bf Example \thedefinition}
\setlength{\itemsep}{0ex} \setlength{\topsep}{0ex}
\setlength{\leftmargin}{3em}} \item }{\end{list}}

\newcounter{ctr3}
\newenvironment{examples}{\begin{list}{\arabic{ctr3}.}%
{\usecounter{ctr3} \addtocounter{definition}{1} \item[]
{\bf Examples \thedefinition }
%{\usecounter{ctr3} \addtocounter{subsection}{1} \item[] %book style
%{\bf Examples \thesubsection }                          %book style            %{\usecounter{ctr3} \addtocounter{subsubsection}{1} \item[] %article style
%{\bf Examples \thesubsubsection }                          %article style
\setlength{\itemsep}{0ex} \setlength{\topsep}{0ex}
\setlength{\leftmargin}{3em}}}{\end{list}}
...
% format of new theorem-like environments follows
% \newtheorem{name}{printed caption}[name of environment in which numbered]
% or
% \newtheorem{name}[numbered as another theorem type]{printed caption}

%\newtheorem{definition}{Definition}[section]    %for book style
\newtheorem{definition}{Definition}[subsection] %for article style
